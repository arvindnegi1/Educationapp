...
int show=0;
GridView subjects;
int logo[]={R.drawable.maths,R.drawable.science,R.drawable.english,R.drawable.nda,R.drawable.force,R.drawable.video,R.drawable.testseries};
   String text[]={"MATHS","SCIENCE","ENGLISH","NDA","AFCAT","VIDEO LECTURE","TEST SERIES"};
    @Override
